...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        // next: screenshot
        // only shown if enabled, enbaled by default
        ...
        // only shown if enabled and expanded desktop is enabled, enabled by default
        boolean showExpandedDesktop = Settings.System.getIntForUser(cr,
                        Settings.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 1, UserHandle.USER_CURRENT) == 1;
