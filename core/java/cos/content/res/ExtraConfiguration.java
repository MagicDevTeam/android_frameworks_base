...
public class ExtraConfiguration
    ...
    public static final String CONTACTS_PKG_NAME = ThemeResources.CONTACTS_PACKAGE;//"com.android.contacts";

    public static final String LAUNCHER_PKG_NAME = ThemeResources.LAUNCHER_PACKAGE;//"com.android.launcher3";

    public static final String DIALER_PKG_NAME = ThemeResources.DIALER_PACKAGE;//"com.android.dialer";

    public static final String MMS_PKG_NAME = ThemeResources.MMS_PACKAGE;//"com.android.mms";

    public static final String SETTINGS_PKG_NAME = ThemeResources.SETTINGS_PKG_NAME;//"com.android.settings";

    public static final String SYSTEMUI_PKG_NAME = ThemeResources.SYSTEMUI_PACKAGE;//"com.android.systemui";
