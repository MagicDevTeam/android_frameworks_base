        ...
        public void run() {
            ...
            if (isPressed()) {
                ...
                if (mLongpressAction != null
                    && MagicActions.isActionKeyEvent(mLongpressAction)) {
...
>>>>>>> 34d6168... New Theme Engine [1/6]
                ...
                if (!mIsLongpressed) {
                    if (isPressed()) {
                        if (mClickAction != null
                            && !MagicActions.isActionKeyEvent(mClickAction)) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            MagicActions.processAction(mContext, mClickAction, false);
            return;
        }
    };
    ...
    private OnLongClickListener mLongPressListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            MagicActions.processAction(mContext, mLongpressAction, true);
            return true;
        }
    };
