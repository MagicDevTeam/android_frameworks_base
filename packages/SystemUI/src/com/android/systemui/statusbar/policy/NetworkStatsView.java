...
public class NetworkStatsView extends LinearLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NETWORK_STATS), false,
                    this);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL), false,
                    this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NETWORK_STATS_TEXT_COLOR),
                    false, this);
            onChange(true);
        }
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            ...
            } else if (mTextViewRx != null) {
                mNetStatsColor = mTextViewRx.getTextColors().getDefaultColor();
            } else {
                mNetStatsColor = 0xffffffff;
            }
