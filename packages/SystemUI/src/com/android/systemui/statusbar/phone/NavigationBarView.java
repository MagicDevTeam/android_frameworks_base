...
public class NavigationBarView extends LinearLayout implements BaseStatusBar.NavigationBarCallback {
    ...
    private static final boolean NAV_RING_DISABLED = true;
...
*/
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        final boolean disableSearch = !NAV_RING_DISABLED;
        ...
        final boolean showNotifs = (disableHome && !disableSearch) //showSearch
            && Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_NOTIFICATIONS, 1) == 1
            && Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, 0) == 0;
        View Notifs = getNotifsButton();
        if (Notifs != null) {
            setVisibleOrGone(Notifs, showNotifs && mWasNotifsButtonVisible);
        }
