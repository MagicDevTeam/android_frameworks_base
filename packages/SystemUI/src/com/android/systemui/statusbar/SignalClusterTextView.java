...
public class SignalClusterTextView
    ...
    private int mSignalClusterTextColor;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_SIGNAL_TEXT_COLOR), false, this);
        }
    ...
    final void updateSignalText() {
        ...
        if (mAirplaneMode || dBm == 0) {
            ...
            mMobileSignalText.setTextColor(mSignalClusterTextColor);
        } else {
            mMobileGroup.setVisibility(View.GONE);
        }
    }
    ...
    private void updateSettings() {
        ...
        mSignalClusterTextColor = Settings.System.getIntForUser(resolver, 
                Settings.System.STATUS_BAR_SIGNAL_TEXT_COLOR, -2, UserHandle.USER_CURRENT);
        
        int defaultColor = this.getResources().getColor(R.color.batterymeter_charge_color);
        
        if (mSignalClusterTextColor == -2) {
            mSignalClusterTextColor = defaultColor;
        }
